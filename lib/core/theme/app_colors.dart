...
class AppColors extends ThemeExtension<AppColors> {
  ...
  static const AppColors dark = AppColors(
    ...
    primary: Color(0xFFE0B584),
    onPrimary: Color(0xFF2A1508),
    primaryContainer: Color(0xFF3A2716),
    onPrimaryContainer: Color(0xFFF0D6B8),
  ...
  static const AppColors light = AppColors(
    ...
    bgBase: Color(0xFFF7F2E9),
    bgGrouped: Color(0xFFF0E9DC),
    surface: Color(0xFFFFFFFF),
    surfaceRaised: Color(0xFFFFFFFF),
    label: Color(0xFF17120C),
    labelSecondary: Color(0xFF6B5F4F),
    labelTertiary: Color(0xFF857A6B),
    separator: Color(0xFFE2D8C4),
    primary: Color(0xFF6B3F1D),
    onPrimary: Color(0xFFFFFFFF),
    primaryContainer: Color(0xFFEFDFC8),
    onPrimaryContainer: Color(0xFF4A2C17),
    accent: Color(0xFFB93217),
    onAccent: Color(0xFFFFFFFF),
    accentContainer: Color(0xFFFFDCC6),
    onAccentContainer: Color(0xFF8A2F0E),
  ...
  static const AppColors darkHighContrast = AppColors(
    ...
    primary: Color(0xFFF0D2AC),
    onPrimary: Color(0xFF2A1508),
    primaryContainer: Color(0xFF33220F),
    onPrimaryContainer: Color(0xFFF8E6CE),
  ...
  static const AppColors lightHighContrast = AppColors(
    ...
    labelSecondary: Color(0xFF4A4033),
    labelTertiary: Color(0xFF695C4F),
    separator: Color(0xFF93805F),
    primary: Color(0xFF4A2C17),
    onPrimary: Color(0xFFFFFFFF),
    primaryContainer: Color(0xFFEFDFC8),
    onPrimaryContainer: Color(0xFF3B2416),
    accent: Color(0xFF9E2A11),
    onAccent: Color(0xFFFFFFFF),
    accentContainer: Color(0xFFFFDCC6),
    onAccentContainer: Color(0xFF6E2408),
